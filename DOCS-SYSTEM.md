...
in what actually changed, never THEORY or old ADRs, and leaves every edit
...
- [ ] `THEORY.md` <=1 page - `MAP.md` <=2 pages - each ADR <=1/2 page - `STATE.md` <=1 page.
...
- [ ] `THEORY.md` intent is confirmed (no lingering `(inferred)` tags).
